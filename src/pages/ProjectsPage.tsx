                ...
                <div className="flex -space-x-2 overflow-hidden">
                  {project.assignedDeveloperIds.map((devId) => {
                    ...
                    return (
                      <div 
                        key={devId}
                        className="inline-block h-8 w-8 rounded-full border-2 border-white bg-slate-100 text-[10px] font-bold flex items-center justify-center dark:border-slate-900 dark:bg-slate-800"
                        title={dev?.name}
                      >
                        {dev?.name.charAt(0)}
                      </div>
